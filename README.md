...
- **Mistral-Nemo fine-tuning on messy data** — real venting language is fragmented, informal, and emotionally ambiguous; the Amod dataset provided counselor-facing text which required preprocessing to match the register of actual user input
